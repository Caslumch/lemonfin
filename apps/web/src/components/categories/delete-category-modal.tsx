        ...
        <div className="w-full max-w-sm bg-surface rounded-[24px] shadow-xl">
          ...
          <div className="p-6">
            <p className="text-sm text-fg-secondary mb-6">
              ...
              <strong className="text-fg">{categoryName}</strong>? As transações
              e contas fixas dela passarão para{" "}
              <strong className="text-fg">Outros</strong>. Esta ação não pode ser
              desfeita.
            </p>
