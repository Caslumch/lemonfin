      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            ref={ref}
            className={cn(
              "w-full rounded-[12px] border-[1.5px] border-border bg-surface px-3.5 py-2.5 text-sm font-[family-name:var(--font-body)] text-fg placeholder:text-fg-muted transition-colors duration-150",
